...
from learning_assistant.toggles import ENABLE_COURSE_CONTENT
...
def render_prompt_template(request, user_id, course_id, unit_usage_key):
    ...
    unit_content_enabled = ENABLE_COURSE_CONTENT.is_enabled(course_run_key)
    log.warning('****************')
    log.warning(unit_content_enabled)
    if unit_usage_key and unit_content_enabled:
