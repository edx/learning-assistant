...
test_requirements:
	pip-sync -q requirements/test.txt requirements/quality.txt
...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd learning_assistant && ../manage.py makemessages -l en -v1 -d django
	cd learning_assistant && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd learning_assistant && ../manage.py compilemessages

detect_changed_source_translations:
	cd learning_assistant && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd learning_assistant && i18n_tool dummy
