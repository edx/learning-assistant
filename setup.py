#!/usr/bin/env python
"""
Package metadata for learning_assistant.
"""
import os
import re
import sys
...
VERSION = get_version('learning_assistant', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""Plugin for a learning assistant backend, intended for use within edx-platform""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='team-cosmonauts@edx.org',
    url='https://github.com/openedx/learning-assistant',
